# may/18/2020 10:29:04 by RouterOS 6.46.6
...
add admin-mac=BE:64:A6:48:7B:F7 auto-mac=no comment=Local dhcp-snooping=yes \
    name=bridge1-LAN priority=0 pvid=30 vlan-filtering=yes
add admin-mac=EA:46:9C:B9:A1:C4 auto-mac=no comment=Wi-Fi-corporate name=\
    bridge2-WiFi-corp priority=0x1000 vlan-filtering=yes
add admin-mac=86:83:33:27:82:2C auto-mac=no comment=Wi-Fi-guest name=\
    bridge3-WiFi-guest priority=0x1000 vlan-filtering=yes
/interface ethernet
set [ find default-name=ether23 ] comment=WAN
set [ find default-name=ether24 ] comment=WAN
/interface vlan
add comment=MGMT interface=bridge1-LAN name=bridge1-LAN.77 vlan-id=77
/interface list
add name=WAN
add name=LAN
...
/queue simple
add disabled=yes dst=ether1 max-limit=10M/10M name=All target=192.168.0.0/16
add disabled=yes dst=ether1 limit-at=5M/5M max-limit=10M/10M name=Local \
    parent=All priority=2/2 queue=pcq-upload-default/pcq-download-default \
    target=192.168.188.0/24
add disabled=yes dst=ether1 max-limit=5M/5M name=WiFi-corp parent=All \
    priority=6/6 queue=pcq-upload-default/pcq-download-default target=\
    192.168.210.0/24
add disabled=yes dst=ether1 max-limit=5M/5M name=WiFi-guest parent=All queue=\
    pcq-upload-default/pcq-download-default target=192.168.220.0/24
/user group
set full policy="local,telnet,ssh,ftp,reboot,read,write,policy,test,winbox,pas\
    sword,web,sniff,sensitive,api,romon,dude,tikapp"
/interface bridge port
add bridge=bridge1-LAN interface=ether2 pvid=30
add bridge=bridge1-LAN interface=ether3 pvid=30
add bridge=bridge1-LAN interface=ether4 pvid=30
add bridge=bridge1-LAN interface=ether5 pvid=30
add bridge=bridge1-LAN interface=ether6 pvid=30
add bridge=bridge1-LAN interface=ether7 pvid=30
add bridge=bridge1-LAN interface=ether8 pvid=30
add bridge=bridge1-LAN interface=ether9 pvid=30
add bridge=bridge1-LAN interface=ether10 pvid=30
add bridge=bridge1-LAN interface=ether11 pvid=30
add bridge=bridge1-LAN interface=ether12 pvid=30
add bridge=bridge1-LAN interface=ether13 pvid=30
add bridge=bridge1-LAN interface=ether14 pvid=30
add bridge=bridge1-LAN interface=ether15 pvid=30
add bridge=bridge1-LAN interface=ether17 pvid=30
add bridge=bridge1-LAN interface=ether18 pvid=30
add bridge=bridge1-LAN interface=ether19 pvid=30
add bridge=bridge1-LAN interface=ether20 pvid=30
add bridge=bridge1-LAN interface=ether21 pvid=30 trusted=yes
add bridge=bridge1-LAN interface=ether22 pvid=30 trusted=yes
add bridge=bridge1-LAN interface=ether23 pvid=30
add bridge=bridge-WAN interface=ether24
add bridge=bridge1-LAN interface=sfp1 pvid=30
add bridge=bridge1-LAN interface=ether1 pvid=30
/ip settings
set tcp-syncookies=yes
/interface bridge vlan
add bridge=bridge1-LAN tagged=ether21,ether22 vlan-ids=30
add bridge=bridge1-LAN comment=MGMT tagged=bridge1-LAN,ether21,ether22 \
    vlan-ids=77
...
add interface=bridge1-LAN.77 list=LAN
/ip address
...
add address=10.0.77.1/24 comment=MGMT interface=bridge1-LAN.77 network=\
    10.0.77.0
/ip dhcp-client
...
add address=172.24.113.0/24 list=management
/ip firewall filter
...
add action=masquerade chain=srcnat dst-address=!192.168.0.0/16 out-interface=\
    bridge-WAN src-address=192.168.0.0/16
/ip route
