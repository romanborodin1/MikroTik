# may/18/2020 17:06:52 by RouterOS 6.46.6
# software id = T5E2-YQAB
#
# model = CRS125-24G-1S
# serial number = 945008BCA4E7
/interface bridge add admin-mac=CC:2D:E0:90:4B:E2 auto-mac=no name=bridge1
...
/interface vrrp add interface=bridge1.30 name=vrrp_vlan30 priority=110
/interface vrrp add interface=bridge1.31 name=vrrp_vlan31 priority=110
...
/interface bridge port add bridge=bridge1 disabled=yes interface=sfp1
...
/interface bridge port add bridge=bridge1 interface=ether21 path-cost=50
...
/interface ethernet switch vlan add ports=ether1,ether13,ether14,ether15,ether16,ether17,ether18,ether19,ether20,ether21,ether22,switch1-cpu vlan-id=31
/interface ethernet switch vlan add ports=ether2,ether3,ether4,ether5,ether6,ether7,ether8,ether9,ether10,ether11,ether12,ether13,ether14,ether15,ether16,ether17,ether18,ether19,ether20,ether21,ether22,switch1-cpu vlan-id=30
/ip address add address=192.168.30.2/24 comment=Office interface=bridge1.30 network=192.168.30.0
/ip address add address=172.16.31.2/24 comment=Guest interface=bridge1.31 network=172.16.31.0
/ip address add address=172.172.1.42/30 network=172.172.1.40
...
/ip dhcp-client add comment=WAN disabled=no interface=ether24
...
/system identity set name=SW_Main
