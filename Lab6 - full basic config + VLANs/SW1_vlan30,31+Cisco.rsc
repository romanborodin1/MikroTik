# jun/01/2020 15:03:38 by RouterOS 6.45.9
...
add client-to-client-forwarding=yes local-forwarding=yes name=\
    local-forwarding-Office vlan-id=30 vlan-mode=no-tag
add client-to-client-forwarding=yes local-forwarding=yes name=\
...
set drop-if-invalid-or-src-port-not-member-of-vlan-on-ports="ether1,ether3,eth\
    er4,ether5,ether6,ether7,ether8,ether9,ether10,ether11,ether12,ether13,eth\
    er14,ether15,ether16,ether17,ether18,ether19,ether20,ether21,ether22"
/interface list
add name=WAN
...
add customer-vid=0 new-customer-vid=30 ports="ether1,ether2,ether3,ether4,ethe\
    ...
    er15,ether16,ether17,ether18,ether19,ether20,ether21,ether22,sfp1"
...
add ports="ether1,ether2,ether3,ether4,ether5,ether6,ether7,ether8,ether9,ethe\
    ...
    9,ether20,ether21,ether22,sfp1,switch1-cpu" vlan-id=30
